...
export function ReferenceFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-40 hidden h-12 w-12 items-center justify-center rounded-full glass-strong border border-dune-gold/20 shadow-lg transition-all duration-200 hover:border-dune-gold/40 hover:shadow-[0_0_20px_rgba(244,207,139,0.1)] lg:flex xl:hidden"
